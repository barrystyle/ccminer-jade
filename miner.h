...
extern int scanhash_jad8(int thr_id, struct work* work, uint32_t max_nonce, unsigned long *hashes_done);
...
extern void free_jad8(int thr_id);
...
void jad8_hash(void *output, const void *input);
