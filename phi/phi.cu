...
extern "C" void jad8_hash(void *output, const void *input)
{
...
#define _DEBUG_PREFIX "jad8"
#include "cuda_debug.cuh"

static bool init[MAX_GPUS] = { 0 };

extern "C" int scanhash_jad8(int thr_id, struct work* work, uint32_t max_nonce, unsigned long *hashes_done)
{
...
// cleanup
extern "C" void free_jad8(int thr_id)
{
	if (!init[thr_id])
		return;
